...
public class ProfessorRestController {
    ...
    public Professor buscar(@PathVariable String nome) {
        return (Professor) professorRepository.findProfessorByNomeContaining(nome);
    }
    ...
    public void inserirVarios(@RequestBody List<Professor> professor) {
        professorRepository.saveAll(professor);
    }
}
